    ...
    public class CustomersRepository : ICustomersRepository
    {
        ...
        public bool Insert(Customers customers)
        {
            using (var connection = _context.CreateConnection())
            {
                ...
                parameters.Add("ContacName", customers.ContacName);
                parameters.Add("ContacTitle", customers.ContacTitle);
        ...
        public Customers Get(string customerId)
        {
            using (var connection = _context.CreateConnection())
            {
                ...
                var parameters = new DynamicParameters();
                parameters.Add("CustomerID", customerId);
                var customer = connection.QuerySingle<Customers>(query, parameters, commandType: System.Data.CommandType.StoredProcedure);
                return customer;
            }
        }
        ...
        public IEnumerable<Customers> GetAll()
        {
            using (var connection = _context.CreateConnection())
            {
                ...
                var customers = connection.Query<Customers>(query, commandType: System.Data.CommandType.StoredProcedure);
                return customers;
            }
        }
        public IEnumerable<Customers> GetAllWithPagination(int pageNumber, int pageSize)
        {
            ...
            var customers = connection.Query<Customers>(query, param: parameters, commandType: System.Data.CommandType.StoredProcedure);
            return customers;            
        }
        ...
        public async Task<Customers> GetAsync(string customerId)
        {
            using (var connection = _context.CreateConnection())
            {
                ...
                var parameters = new DynamicParameters();
                parameters.Add("CustomerID", customerId);
                var customer = await connection.QuerySingleAsync<Customers>(query, parameters, commandType: System.Data.CommandType.StoredProcedure);
                return customer;
            }
        }
        ...
        public async Task<IEnumerable<Customers>> GetAllAsync()
        {
            ...
            {
                var query = "CustomersList";
                var customers = await connection.QueryAsync<Customers>(query, commandType: System.Data.CommandType.StoredProcedure);
                return customers;
            }
        }
        ...
        public async Task<IEnumerable<Customers>> GetAllWithPaginationAsync(int pageNumber, int pageSize)
        {
            ...
            parameters.Add("PageNumber", pageNumber);
            parameters.Add("PageSize", pageSize);
            var customers = await connection.QueryAsync<Customers>(query, param: parameters, commandType: System.Data.CommandType.StoredProcedure);
            return customers;
        }
        ...
        public async Task<int> CountAsync()
        {
            using var connection = _context.CreateConnection();
            var query = "Select Count(*) from Customers";
            var count = await connection.ExecuteScalarAsync<int>(query, commandType: System.Data.CommandType.Text);
            return count;
        }
